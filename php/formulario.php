...
if(!isset($_SESSION['erroresRegistro'])||$_SESSION['erroresRegistro']==null){
...
if(isset($_SESSION['erroresRegistro']) && count($_SESSION['erroresRegistro'])>0){
...
<html>
	<head>
		<title>Thor Comics - Formulario de Registro</title>
	...
	<body>
		...
		<div id="page" >
			...
			<form id="formulario_inscripcion" name="formulario_inscripcion" method="post" action="cgi-bin/registro.php" >
				...
				<fieldset id="fieldsetright">
					...
					<img id="rojoC2" src="media/rojo.jpg" alt="no-pic" >
					...
					<input name="botonR" type="submit" value="Registrarme" onclick="validaTodo()" >
